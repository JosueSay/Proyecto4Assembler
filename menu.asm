...
.data
	...
	msg_instrucciones2 BYTE "Las ranas del color AZUL son 'a', 'b' y 'c' y las ranas de color ROJO son 'd', 'e', 'f'.", 0
	msg_instrucciones3 BYTE "Toma en cuenta lo siguiente:", 0
	msg_instrucciones4 BYTE "\ti.	Las ranas no pueden retroceder", 0
	msg_instrucciones5 BYTE "\tii.	Solo pueden moverse un espacio a la vez.", 0
	msg_instrucciones6 BYTE "\tiii.	Las ranas de distinta especie pueden saltarse otra rana si existe un espacio vació adelante.", 0
	msg_instrucciones7 BYTE "\tiv.	Sin embargo, las ranas de la misma especie no pueden saltarse entre ellas.", 0
